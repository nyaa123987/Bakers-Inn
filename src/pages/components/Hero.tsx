...
export default function Hero() {
    return(
        <main>
            <section className="flex w-[100%] h-[60vh] md:h-[80vh] justify-center items-center bg-[#261B6C] text-[white]">
                <div className="pl-[3%] md:w-[60%]">
                    <H1 className="text-xl md:text-[60px]">Bringing you the best value at the best prices.</H1>
