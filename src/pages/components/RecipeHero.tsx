  ...
  return (
    <main className='bg-white flex flex-col justify-center md:justify-start md:flex-row px-[3%] items-center py-[5vh] md:py-[3vh]'>
        <div className='flex flex-col justify-center items-center md:items-start'>
            ...
            <p className='text-sm md:text-lg text-[#261B6C] pb-[1vh] text-center md:text-start'>Make the finest croissants worthy of    Paris from your     home</p>
            <p className='text-sm md:text-lg text-[#261B6C] pb-[1vh] text-center md:text-start'>#Croissant #Zimbabwe #Paris #Baker’s_Inn</p>
