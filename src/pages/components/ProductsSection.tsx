...
export default function ProductsSection() {
  ...
  const productsData: Record<string, any[]> = {
    ...
    pies: [
      { title: 'Premium Soft White Loaf', info: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.', img: '/images/ProductMeatpie.png' },
      { title: 'Family Loaf High Energy Brown', info: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.', img: '/images/ProductMeatpie.png' },
      { title: 'Family Loaf Soft White', info: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.', img: '/images/ProductMeatpie.png' },
    ],
    scones: [
      { title: 'Sugar Free Scone', info: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.', img: '/images/ProductScone.png' },
      { title: 'Sugar Free Scone', info: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.', img: '/images/ProductScone.png' },
      { title: 'Sugar Free Scone', info: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.', img: '/images/ProductScone.png' },
    ],
    donuts: [
      { title: 'Chocolate Donut', info: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.', img: '/images/ProductBrown.png' },
      { title: 'Chocolate Donut', info: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.', img: '/images/ProductWhite.png' },
      { title: 'Chocolate Donut', info: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.', img: '/images/ProductBrown.png' },
    ],
  };
    ...
    <section className="bg-white px-4 md:px-12 md:py-8 pt-[15vh]">
      ...
      {activeTab === 'bread' ? (
        <div className="flex overflow-x-auto gap-6 pb-14">
            ...
            <div 
                key={idx} 
                className="flex-shrink-0 w-[30%] sm:w-[35%] md:w-[30%] lg:w-[30%]"
            >
                <ProductCard
                title={product.title}
                info={product.info}
