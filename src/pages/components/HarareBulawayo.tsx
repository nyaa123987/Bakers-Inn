    ...
    return(
        <main className='flex justify-center gap-[10%] bg-[#F7F5E8] px-[5%] py-[12vh] md:my-[20vh]'>
            <div>
                ...
                <h2 className='text-sm md:text-3xl font-semibold text-[#261B6C] my-4'>Harare Bread Factory</h2>
...
Econet Toll Free: 08080151, 08080152`}</P>
            ...
            <div>
                ...
                <h2 className='text-sm md:text-3xl font-semibold text-[#261B6C] my-4'>Bulawayo Bread Factory</h2>
